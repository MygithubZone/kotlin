...
class PoesiaFragment : BaseVMFragment<PoesiaViewModel>(), OnItemClickListener, MenuTypeAdapter.OnMenuItemClickListener {
    override fun onItemClick(ad: MenuTypeAdapter, selection: Int, position: Int, itemView: View) {
        ...
        when (ad!!.selectType) {
            ...
            1 -> {
                ...
                mChaoSheetDialog?.show()
            }
            2 -> {
                mXingSheetDialog?.show()
            }
        }
    }
    ...
    var mChaoSheetDialog: BottomSheetDialog? = null
    var mXingSheetDialog: BottomSheetDialog? = null
    var typeAdapter: MenuTypeAdapter? = null
    var chaoAdapter: MenuTypeAdapter? = null
    var xingAdapter: MenuTypeAdapter? = null
    fun initMenu() {
